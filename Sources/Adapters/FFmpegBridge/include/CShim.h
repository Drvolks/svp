...
void svp_ffmpeg_multi_demuxer_destroy(void *demuxer);
int32_t svp_ffmpeg_multi_demuxer_read_packet(void *demuxer, svp_ffmpeg_demuxed_packet_t *outPacket);
...
int32_t svp_ffmpeg_multi_demuxer_stream_count(void *demuxer);
int32_t svp_ffmpeg_multi_demuxer_stream_info(void *demuxer, int32_t index, svp_ffmpeg_stream_info_t *outInfo);
int32_t svp_ffmpeg_multi_demuxer_stream_codec_config(void *demuxer, int32_t index, svp_ffmpeg_codec_config_t *outConfig);
